...
const CalendarAppAdmin = () => {
  ...
  const createBooking = async (bookingData) => {
    ...
    const res = await fetch('http://localhost:7777/api/create', {
      method: 'POST',
      headers: {
  ...
  const updateBooking = async (updatedData) => {
    ...
    const res = await fetch(`http://localhost:7777/api/update`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const deleteBooking = async (uuid) => {
    const res = await fetch(`http://localhost:7777/api/delete`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const fetchBookings = async () => {
    const res = await fetch('http://localhost:7777/api/get');
    const data = await res.json();
    try {
